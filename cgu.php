...
<section id="background5">
    ...
    <h1 class="countheads_cgu">Conditions générales d'utilisation - Données personnelles :</h1>

    <br>

        <h3 class="nocount"><u>Définitions</u> :</h3>
            <p class="para_cgu">
                <b>L'Éditeur :</b>La personne, physique ou morale, qui édite les services de communication au
                public en ligne.<br><br>
                <b>Le Site :</b>L'ensemble des sites, pages Internet et services en ligne proposés par l'Éditeur.<br><br>
                <b>L'Utilisateur :</b>La personne utilisant le Site et les services.<br>
            </p>


        <h3 class="cgu_title">Nature des données collectées :</h3>
            <p class="para_cgu"><b>Dans le cadre de l'utilisation des Sites, l'Éditeur est susceptible de collecter les catégories de données suivantes concernant ses Utilisateurs :</b></p>

        <div id="C0Q1">
            <p class="para_cgu">Données relatives à la vie personnelle (habitudes de vie, situation familiale, hors données                             ou dangereuses)
            </p>
            <p class="para_cgu">Données de localisation (déplacements, données GPS, GSM...)
            </p>
        </div>


        <div id="C1Q1">
        <h3 class="cgu_title">Communication des données personnelles à des tiers :</h3>
            <p class="para_cgu"><b>Pas de communication à des tiers :</b>

    <br>

    Vos données ne font l'objet d'aucune communication à des tiers. Vous êtes toutefois informés qu'elles pourront être divulguées en application d'une loi, d'un règlement ou en vertu d'une décision d'une autorité réglementaire ou judiciaire compétente.</p>
        </div>
        ...
        <div id="C3Q1">
        <h3 class="cgu_title">Information préalable pour la communication des données personnelles à des tiers en cas de fusion
        / absorption :</h3>
            <p class="para_cgu"><b>Collecte de l’opt-in (consentement) préalable à la transmission des données suite
                    à une fusion / acquisition :</b>
    ...
    Dans  le cas où nous prendrions part à une opération de fusion, d’acquisition ou à toute autre forme de cession d’actifs, nous nous engageons à obtenir votre consentement préalable à la transmission de vos données personnelles et à maintenir le niveau de confidentialité de vos données personnelles auquel vous avez consenti.
        ...
        <div id="C4Q1"></div>
        <h3 class="cgu_title">Agrégation des données :</h3>
            <p class="para_cgu"><b>Agrégation avec des données non personnelles :</b>
    ...
    Nous pouvons publier, divulguer et utiliser les informations agrégées (informations relatives à tous nos Utilisateurs ou à des groupes ou catégories spécifiques d'Utilisateurs que nous combinons de manière à ce qu'un Utilisateur individuel ne puisse plus être identifié ou mentionné) et les informations non personnelles à des fins d'analyse du secteur et du marché, de profilage démographique, à des fins promotionnelles et publicitaires et à d'autres fins commerciales.</p>
            ...
            <p class="para_cgu"><b>Agrégation avec des données personnelles disponibles sur les comptes sociaux de
                    l'Utilisateur :</b>

    <br>

    Si vous connectez votre compte à un compte d’un autre service afin de faire des envois croisés, ledit service pourra
a nous communiquer vos informations de profil, de connexion, ainsi que toute autre information dont
...
Utilisateurs, groupes, comptes, aux données personnelles disponibles sur l’Utilisateur.</p>
        ...
        <div id="C6Q1">
        <h3 class="cgu_title">Collecte des données d'identité :</h3>
            <p class="para_cgu"><b>Inscription et identification préalable pour la fourniture du service :</b>
    ...
    L’utilisation du Site nécessite une inscription et une identification préalable. Vos données nominatives (nom, prénom, adresse postale, e-mail, numéro de téléphone,...) sont utilisées pour exécuter nos obligations légales résultant de la livraison des produits et / ou des services, en vertu du Contrat de licence utilisateur final, de la Limite de garantie, le cas échéant, ou de toute autre condition applicable. Vous ne fournirez pas de fausses informations nominatives et ne créerez pas de compte pour une autre personne sans son autorisation. Vos coordonnées devront toujours être exactes et à jour.</p>
        ...
        <div id="C7Q1">
        <h3 class="cgu_title">Collecte des données d'identification :</h3>
            <p class="para_cgu"><b>Utilisation de l'identifiant de l’utilisateur uniquement pour l’accès aux services :</b>
    ...
    Nous utilisons vos identifiants électroniques seulement pour et pendant l'exécution du contrat.</p>
        ...
        <div id="C8Q1">
        <h3 class="cgu_title">Géolocalisation :</h3>
            <p class="para_cgu"><b>Géolocalisation à des fins de fourniture du service :</b>
    ...
    Nous collectons et traitons vos données de géolocalisation afin de vous fournir nos services. Nous pouvons être amenés à faire usage des données personnelles dans le but de déterminer votre position géographique en temps réel. Conformément à votre droit d'opposition prévu par la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés, vous avez la possibilité, à tout moment, de désactiver les fonctions relatives à la géolocalisation.</p>
            ...
            <p class="para_cgu"><b>Géolocalisation à des fins de croisement :</b>
    ...
    Nous collectons et traitons vos données de géolocalisation afin de permettre à nos services d'identifier les points de croisement dans le temps et dans l'espace avec d'autres Utilisateurs du service afin de vous présenter le profil des Utilisateurs croisés. Conformément à votre droit d'opposition prévu par la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés, vous avez la possibilité, à tout moment, de désactiver les fonctions relatives à la géolocalisation. Vous reconnaissez alors que le service ne sera plus en mesure de vous présenter de profil des autres Utilisateurs.</p>
            ...
            <p class="para_cgu"><b>Géolocalisation avec mise à disposition des partenaires pour référencement et
                    agrégation (avec opt-in) :</b>
    ...
    Nous pouvons collecter et traiter vos données de géolocalisation avec nos partenaires. Nous nous engageons à anonymiser les données utilisées. Conformément à votre droit d'opposition prévu par la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés, vous avez la possibilité, à tout moment, de désactiver les fonctions relatives à la géolocalisation.</p></div>
        ...
        <div id="C9Q1">
        <h3 class="cgu_title">Collecte des données du terminal :</h3>
            <p class="para_cgu"><b>Collecte des données de profilage et des données techniques à des fins de
                    fourniture du service :</b>
    ...
    Certaines des données techniques de votre appareil sont collectées automatiquement par le Site. Ces informations incluent notamment votre adresse IP, fournisseur d'accès à Internet, configuration matérielle, configuration logicielle, type et langue du navigateur... La collecte de ces données est nécessaire à la fourniture des services.</p>
            ...
            <p class="para_cgu"><b>Collecte des données techniques à des fins publicitaires, commerciales et
                    statistiques :</b>
    ...
    Les données techniques de votre appareil sont automatiquement collectées et enregistrées par le Site, à des fins publicitaires, commerciales et statistiques. Ces informations nous aident à personnaliser et à améliorer continuellement votre expérience sur notre Site. Nous ne collectons ni ne conservons aucune donnée nominative (nom, prénom, adresse...) éventuellement attachée à une donnée technique. Les données collectées sont susceptibles d’être revendues à des tiers.</p>
        ...
        <h3 class="cgu_title">Cookies :</h3>
            <p class="para_cgu"><b>Durée de conservation des cookies :</b>
    ...
    Conformément aux recommandations de la CNIL, la durée maximale de conservation des cookies est de 13 mois au maximum après leur premier dépôt dans le terminal de l'Utilisateur, tout comme la durée de la validité du consentement de l’Utilisateur à l’utilisation de ces cookies. La durée de vie des cookies n’est pas prolongée à chaque visite. Le consentement de l’Utilisateur devra donc être renouvelé à l'issue de ce délai.</p>
            ...
            <p class="para_cgu"><b>Finalité cookies :</b>
    ...
    Vous êtes informé que l'Éditeur est susceptible de déposer des cookies sur votre terminal. Le cookie enregistre des informations relatives à la navigation sur le service (les pages que vous avez consultées, la date et l'heure de la consultation...) que nous pourrons lire lors de vos visites ultérieures.</p>
        ...
        <div id="C10Q1">
            <p class="para_cgu"><b>Opt-in pour le dépôt de cookies :</b>

    <br>

    Nous n'utilisons pas de cookies. Si nous devions en utiliser à l’avenir, vous en seriez informé préalablement et auriez la possibilité de désactiver ces cookies.</p>
        </div>


        <h3 class="cgu_title">Conservation des données techniques</h3>
            <p class="para_cgu"><b>Durée de conservation des données techniques :</b>
    ...
    Les données techniques sont conservées pour la durée strictement nécessaire à la réalisation des finalités visées ci-avant.</p>
        ...
        <h3 class="cgu_title">Délai de conservation des données personnelles et d'anonymisation</h3>
        <div id="C12Q1">
            <p class="para_cgu"><b>Pas de conservation des données :</b>

    <br>

    Nous ne conservons aucune donnée personnelle au delà de votre durée de connexion au service pour les finalités décrites dans les présentes CGU.</p>
        </div>

            <p class="para_cgu"><b>Suppression des données après suppression du compte :</b>
    ...
    Des moyens de purge de données sont mis en place afin d'en prévoir la suppression effective dès lors que la durée de conservation ou d'archivage nécessaire à l'accomplissement des finalités déterminées ou imposées est atteinte. Conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés, vous disposez par ailleurs d'un droit de suppression sur vos données que vous pouvez exercer à tout moment en prenant contact avec l'Éditeur.</p>
            ...
            <p class="para_cgu"><b>Suppression des données après 3 ans d'inactivité :</b>
    ...
    Pour des raisons de sécurité, si vous ne vous êtes pas authentifié sur le Site pendant une période de trois ans, vous recevrez un e-mail vous invitant à vous connecter dans les plus brefs délais, sans quoi vos données seront supprimées de nos bases de données.</p>
        ...
        <h3 class="cgu_title">Suppression du compte</h3>
            <p class="para_cgu"><b>Suppression du compte à la demande :</b>

    <br>

    L'Utilisateur a la possibilité de supprimer son Compte à tout moment, par simple demande à l'Éditeur OU par le menu de suppression de Compte présent dans les paramètres du Compte le cas échéant.</p>

            <p class="para_cgu"><b>Suppression du compte en cas de violation des CGU :</b>
    ...
    En cas de violation d'une ou de plusieurs dispositions des CGU ou de tout autre document incorporé aux présentes par référence, l'Éditeur se réserve le droit de mettre fin ou restreindre sans aucun avertissement préalable et à sa seule discrétion, votre usage et accès aux services, à votre compte et à tous les Sites.</p>
        ...
        <h3 class="cgu_title">Indications en cas de faille de sécurité décelée par l'Éditeur</h3>
            <p class="para_cgu">Nous nous engageons à mettre en oeuvre toutes les mesures techniques et
                organisationnelles appropriées afin de garantir un niveau de sécurité adapté au regard des risques d'accès accidentels, non autorisés ou illégaux, de divulgation, d'altération, de perte ou encore de destruction des données personnelles vous concernant.
    Dans l'éventualité où nous prendrions connaissance d'un accès illégal aux données personnelles vous concernant stockées sur nos serveurs ou ceux de nos prestataires, ou d'un accès non autorisé ayant pour conséquence la réalisation des risques identifiés ci-dessus, nous nous engageons à :</p>
    ...
    <br>
            ...
            <p class="para_cgu"><b>Limitation de la responsabilité :</b>

    <br>

    En aucun cas les engagements définis au point ci-dessus relatifs à la notification en cas de faille de sécurité ne peuvent être assimilés à une quelconque reconnaissance de faute ou de responsabilité quant à la survenance de l'incident en question.</p>


        <div id="C15Q1">
        <h3 class="cgu_title">Transfert des données personnelles à l'étranger</h3>
            <p class="para_cgu"><b>Pas de transfert en dehors de l'Union européenne :</b>

    <br>

    L'Éditeur s'engage à ne pas transférer les données personnelles de ses Utilisateurs en dehors de l'Union européenne.</p>
        </div>

        <h3 class="cgu_title">Modification des CGU et de la politique de confidentialité</h3>
            <p class="para_cgu"><b>En cas de modification des présentes CGU, engagement de ne pas baisser le niveau
                    de confidentialité de manière substantielle sans l'information préalable des personnes concernées :</b>
    ...
    Nous nous engageons à vous informer en cas de modification substantielle des présentes CGU, et à ne pas baisser le niveau de confidentialité de vos données de manière substantielle sans vous en informer et obtenir votre consentement.</p>
        ...
        <div id="C17Q1">
        <h3 class="cgu_title">Droit applicable et modalités de recours</h3>
            <p class="para_cgu"><b>Application du droit français (législation CNIL) et compétence des tribunaux :</b>
    ...
    En cas de litige, les parties chercheront une solution amiable avant toute action judiciaire. En cas d'échec de ces tentatives, toutes contestations à la validité, l'interprétation et / ou l'exécution des présentes CGU devront être portées même en cas de pluralité des défendeurs ou d'appel en garantie, devant les tribunaux français.</p>
        ...
        <div id="C18Q1">
        <h3 class="cgu_title">Portabilité des données</h3>
            <p class="para_cgu"><b>Portabilité des données :</b>
