...
<div id="C1Q1"> <h3 class="cgu_title">Communication des données personnelles à des tiers :</h3><p>
        <b>
...
<div id="C3Q1"> <h3 class="cgu_title">Information préalable pour la communication des données personnelles à des tiers en cas de fusion
        / absorption :</h3><b>
...
<div id="C6Q1"> <h3 class="cgu_title">Collecte des données d'identité</h3><p>
        <b>
...
<div id="C7Q1"> <h3 class="cgu_title">Collecte des données d'identification</h3><p>
        <b>
...
<div id="C8Q1"> <h3 class="cgu_title">Géolocalisation</h3><p>
        <b>
...
<div id="C9Q1"> <h3 class="cgu_title">Collecte des données du terminal</h3><p>
        <b>
...
<div id="C15Q1"> <h3 class="cgu_title">Transfert des données personnelles à l'étranger</h3><p>
        <b>
...
<div id="C17Q1"> <h3 class="cgu_title">Droit applicable et modalités de recours</h3><p>
        <b>
...
<div id="C18Q1"> <h3 class="cgu_title">Portabilité des données</h3><p>
        <b>
